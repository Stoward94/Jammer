...
namespace GamingSessionApp.BusinessLogic
{
    public static class EmailLogic
    {
        ...
        public static async Task NewPrivateMessageEmail(List<ApplicationUser> recipients, string senderName, UserMessage message)
        {
        ...
        private static async Task SendEmail(SendGridMessage email)
        {
